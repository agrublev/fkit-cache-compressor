...
},{"_css_loader":"../../../../usr/local/lib/node_modules/parcel/src/builtins/css-loader.js"}],"dist/index.js":[function(require,module,exports) {
var define;
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

!function (e, r) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = r() : "function" == typeof define && define.amd ? define([], r) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.fkCompressor = r() : e.fkCompressor = r();
}(window, function () {
  return function (e) {
    var r = {};
    ...
    var t, o, i;
    o = [], void 0 === (i = "function" == typeof (t = function t() {
      var e,
          r,
          n = "lscache-",
          t = "-cacheexpiration",
      ...
      function a() {
        ...
        try {
          v(r, "__lscachetest__"), m(r), e = !0;
        } catch (r) {
          e = !(!f(r) || !localStorage.length);
        }
      ...
      function p() {
        return void 0 === r && (r = null != window.JSON), r;
      }
      ...
      function v(e, r) {
        localStorage.removeItem(n + u + e), localStorage.setItem(n + u + e, r);
      }
      ...
      function g(e) {
        for (var r = new RegExp("^" + n + u.replace(/[[\]{}()*+?.\\^$|]/g, "\\$&") + "(.*)"), o = localStorage.length - 1; o >= 0; --o) {
          var i = localStorage.key(o);
          (i = (i = i && i.match(r)) && i[1]) && i.indexOf(t) < 0 && e(i, l(i));
        }
      }
      ...
      function w(e) {
        ...
        if (n) {
          var t = parseInt(n, o);
          if (h() >= t) return m(e), m(r), !0;
        }
      }

      function S(e, r) {
        s && "console" in window && "function" == typeof window.console.warn && (window.console.warn("lscache - " + e), r && window.console.warn("lscache - The error was: " + r.message));
      }
      ...
      return {
        set: function set(e, r, n) {
          ...
          try {
            ...
            if (!f(n)) return S("Could not add item with key '" + e + "'", n), !1;
            var t,
                i = [];
            g(function (e, r) {
              var n = d(r);
              n = n ? parseInt(n, o) : c, i.push({
                key: e,
                size: (d(e) || "").length,
                expiration: n
              });
            }), i.sort(function (e, r) {
              return r.expiration - e.expiration;
            });

            for (var u = (r || "").length; i.length && u > 0;) {
              t = i.pop(), S("Cache is full, removing item with key '" + e + "'"), y(t.key), u -= t.size;
            }

            try {
              v(e, r);
            } catch (r) {
              return S("Could not add item with key '" + e + "', perhaps it's too big?", r), !1;
            }
          }

          return n ? v(l(e), (h() + n).toString(o)) : m(l(e)), !0;
        },
        get: function get(e) {
          if (!a()) return null;
          if (w(e)) return null;
        ...
        setBucket: function setBucket(e) {
          u = e;
        },
        ...
        setExpiryMilliseconds: function setExpiryMilliseconds(e) {
          c = O(i = e);
        },
        enableWarnings: function enableWarnings(e) {
          s = e;
        }
      };
    }) ? t.apply(r, o) : t) || (e.exports = i);
  }, function (e, r, n) {
    "use strict";
    ...
    var t = function () {
      ...
      var r = String.fromCharCode,
        ...
        decompressFromBase64: function decompressFromBase64(r) {
          return null == r ? "" : "" == r ? null : i._decompress(r.length, 32, function (t) {
            return e(n, r.charAt(t));
          });
        },
        ...
        decompressFromUTF16: function decompressFromUTF16(e) {
          return null == e ? "" : "" == e ? null : i._decompress(e.length, 16384, function (r) {
            return e.charCodeAt(r) - 32;
          });
        },
        compressToUint8Array: function compressToUint8Array(e) {
          for (var r = i.compress(e), n = new Uint8Array(2 * r.length), t = 0, o = r.length; o > t; t++) {
            var c = r.charCodeAt(t);
            n[2 * t] = c >>> 8, n[2 * t + 1] = c % 256;
          }
        ...
        decompressFromUint8Array: function decompressFromUint8Array(e) {
          ...
          for (var n = new Array(e.length / 2), t = 0, o = n.length; o > t; t++) {
            n[t] = 256 * e[2 * t] + e[2 * t + 1];
          }
        ...
        _compress: function _compress(e, r, n) {
          if (null == e) return "";
          var t,
              o,
              i,
          ...
          for (i = 0; i < e.length; i += 1) {
            if (s = e.charAt(i), Object.prototype.hasOwnProperty.call(c, s) || (c[s] = l++, u[s] = !0), a = f + s, Object.prototype.hasOwnProperty.call(c, a)) f = a;else {
              if (Object.prototype.hasOwnProperty.call(u, f)) {
                if (f.charCodeAt(0) < 256) {
                  for (t = 0; h > t; t++) {
                    v <<= 1, m == r - 1 ? (m = 0, d.push(n(v)), v = 0) : m++;
                  }

                  for (o = f.charCodeAt(0), t = 0; 8 > t; t++) {
                    v = v << 1 | 1 & o, m == r - 1 ? (m = 0, d.push(n(v)), v = 0) : m++, o >>= 1;
                  }
                } else {
                  for (o = 1, t = 0; h > t; t++) {
                    v = v << 1 | o, m == r - 1 ? (m = 0, d.push(n(v)), v = 0) : m++, o = 0;
                  }

                  for (o = f.charCodeAt(0), t = 0; 16 > t; t++) {
                    v = v << 1 | 1 & o, m == r - 1 ? (m = 0, d.push(n(v)), v = 0) : m++, o >>= 1;
                  }
                }

                0 == --p && (p = Math.pow(2, h), h++), delete u[f];
              } else for (o = c[f], t = 0; h > t; t++) {
                v = v << 1 | 1 & o, m == r - 1 ? (m = 0, d.push(n(v)), v = 0) : m++, o >>= 1;
              }

              0 == --p && (p = Math.pow(2, h), h++), c[a] = l++, f = String(s);
            }
          }
        ...
        decompress: function decompress(e) {
          return null == e ? "" : "" == e ? null : i._decompress(e.length, 32768, function (r) {
            return e.charCodeAt(r);
          });
        },
        _decompress: function _decompress(e, n, t) {
          var o,
              i,
              c,
              u,
          ...
          for (c = 0, s = Math.pow(2, 2), a = 1; a != s;) {
            u = g.val & g.position, g.position >>= 1, 0 == g.position && (g.position = n, g.val = t(g.index++)), c |= (u > 0 ? 1 : 0) * a, a <<= 1;
          }

          switch (c) {
            case 0:
              for (c = 0, s = Math.pow(2, 8), a = 1; a != s;) {
                u = g.val & g.position, g.position >>= 1, 0 == g.position && (g.position = n, g.val = t(g.index++)), c |= (u > 0 ? 1 : 0) * a, a <<= 1;
              }
            ...
            case 1:
              for (c = 0, s = Math.pow(2, 16), a = 1; a != s;) {
                u = g.val & g.position, g.position >>= 1, 0 == g.position && (g.position = n, g.val = t(g.index++)), c |= (u > 0 ? 1 : 0) * a, a <<= 1;
              }
          ...
          for (p[3] = f, i = f, m.push(f);;) {
            if (g.index > e) return "";

            for (c = 0, s = Math.pow(2, d), a = 1; a != s;) {
              u = g.val & g.position, g.position >>= 1, 0 == g.position && (g.position = n, g.val = t(g.index++)), c |= (u > 0 ? 1 : 0) * a, a <<= 1;
            }
            ...
            if (0 == l && (l = Math.pow(2, d), d++), p[f]) v = p[f];else {
              if (f !== h) return null;
              v = i + i.charAt(0);
            }
            m.push(v), p[h++] = i + v.charAt(0), i = v, 0 == --l && (l = Math.pow(2, d), d++);
          }
        }
      };
      return i;
    ...
    function f(e, r, n) {
      ...
      for (r = r || t.length, n = n || 0; i >= r;) {
        o.push(t.charCodeAt(i % r + n)), i = Math.floor(i / r - 1);
      }

      return o.push(t.charCodeAt(i + n)), o.reverse();
    }
    ...
    function l(e, r) {
      ...
      for (r = function e(r, n) {
        var t, o, l, h;

        for (o in r) {
          r.hasOwnProperty(o) && (l = r[o], h = l, ("[object Object]" === c.call(h) || a(l)) && (n = n.concat(s(e(l, n)))), isNaN(Number(o)) && (u(n, o) || ((t = []).push(p(f(i += 1)), o), n.push(t))));
        }
        ...
        return t;
      }(r = s(r)), o = JSON.stringify(e), l = r.length, h = 0; h < l; h++) {
        t = r[h], o = o.replace(new RegExp(('"' + t[1] + '"').replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "g"), '"' + t[0] + '"');
      }

      return (d = JSON.parse(o))._ = n, d;
    }

    o.compress = function (e, r) {
      r || (i = -1);
      var n,
          t = r || [];
      return a(e) ? (!function (e, r) {
        ...
        for (n = 0, t = e.length; n < t; n++) {
          e[n] = o.compress(e[n], r);
        }
      }(e, t), n = e) : n = l(e, t), n;
    }, o.pack = function (e, r) {
      var n = JSON.stringify(r ? o.compress(e) : e);
      return Base64.encode(String.fromCharCode.apply(String, gzip.zip(n, {
        level: 9
      })));
    }, o.decompress = function (e) {
      var r,
      ...
      return a(n) ? function (e) {
        ...
        for (r = 0, n = e.length; r < n; r++) {
          e[r] = o.decompress(e[r]);
        }
      }(n) : r = function (e) {
        var r, n, t;

        for (t in r = JSON.parse(JSON.stringify(e._)), delete e._, n = JSON.stringify(e), r) {
          r.hasOwnProperty(t) && (n = n.replace(new RegExp('"' + t + '"', "g"), '"' + r[t] + '"'));
        }

        return n;
      }(n), r ? JSON.parse(r) : n;
    }, o.unpack = function (e, r) {
      var n = function (e) {
        for (var r = 0, n = e.length, t = []; r < n; r++) {
          t.push(e.charCodeAt(r));
        }

        return t;
      }(Base64.decode(e)),
          t = String.fromCharCode.apply(String, gzip.unzip(n, {
        level: 9
      })),
          i = JSON.parse(t);

      return r ? o.decompress(i) : i;
    };
    var h = o,
        d = n(0),
        v = n.n(d);
    n.d(r, "fkCompressor", function () {
      return x;
    });
    var m = void 0;

    function g(e, r, n, t, o, i, c) {
      try {
        var u = e[i](c),
            s = u.value;
      } catch (e) {
      ...
      u.done ? r(s) : Promise.resolve(s).then(t, o);
    }
    ...
    var w,
      ...
      return Number("".concat(Math.round("".concat(e, "e").concat(r)), "e-").concat(r));
    },
        x = {
      init: function init() {
        ...
        m.dev = e.dev;
        var r = 1e3 * e.expiresAfterSeconds;
        v.a.setExpiryMilliseconds(r);
      },
      _compress: function _compress(e) {
        var r = h.compress(e),
            n = JSON.stringify(r);
        return t.compress(n);
      },
      _decompress: function _decompress(e) {
        var r = t.decompress(e),
            n = {};
        ...
        return h.decompress(n);
      },
      compress: function compress(e) {
        return new Promise(function (r) {
          JSON.stringify(e).length, n = function n() {
            return m._compress(e);
          }, t = Date.now(), o = n(), i = Date.now(), "Time taken ".concat(O((i - t) / 1e3, 2), "s");
      ...
      decompress: function decompress(e) {
        return m._decompress(e);
      },
      set: (S = y(regeneratorRuntime.mark(function e() {
        var r,
            n,
            t,
            o,
        ...
        return regeneratorRuntime.wrap(function (e) {
          for (;;) {
            switch (e.prev = e.next) {
              case 0:
                return r = i.length > 0 && void 0 !== i[0] ? i[0] : Date.now() + "", n = i.length > 1 && void 0 !== i[1] ? i[1] : {}, t = i.length > 2 && void 0 !== i[2] ? i[2] : 2, o = m, e.abrupt("return", new Promise(function (e) {
                  v.a.set(r, o._compress(n), t), e();
                }));
      ...
      get: (w = y(regeneratorRuntime.mark(function e(r) {
        return regeneratorRuntime.wrap(function (e) {
          for (;;) {
            switch (e.prev = e.next) {
              case 0:
                return e.abrupt("return", new Promise(function (e) {
                  var n = v.a.get(r);
                  n ? e(m.decompress(n)) : (console.warn("Item expired or doesn't exist"), e({}));
                }));
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          Compressor = new _index.default(); // Compressor.setBucket("KIT");
...
},{"../dist/index.js":"dist/index.js","./sample.json":"src/sample.json"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
},{"./styles.css":"src/styles.css","./sample.js":"src/sample.js"}],"../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
